...
class Create:
    ...
    tournament = Button(1920//2 - 250, 1000, 0, 500, 50, "Tournament (10 Runden)", (0, 110, 18), 40)
    tournament.setTextRect()
    uiEntities.append(tournament)

    switchLModus = Button((1920//2 - 350), 1000, 0, 50, 50, "<<", (0,110,18), 40)
    switchLModus.setBgColor((67 ,181 ,207))
    switchLModus.setTextRect()
    uiEntities.append(switchLModus)
     
    switchRModus = Button((1920//2 + 300), 1000, 0, 50, 50, ">>", (0,110,18), 40)
    ...
    pTwoAlgorithm = Label((1920//4)*3, 805, 0, 1, 1, "A Star", (0, 110, 18), 40)
    pTwoAlgorithm.setTextRect()
    uiEntities.append(pTwoAlgorithm)

    switchLTwoAlgorithm = Button((1920//16)*11 - 40, 790, 0, 50, 40, "<<", (0,110,18), 40)
    switchLTwoAlgorithm.setTextRect()
    uiEntities.append(switchLTwoAlgorithm)
    
    switchRTwoAlgorithm = Button((1920//16)*13, 790, 0, 50, 40, ">>", (0,110,18), 40)
    switchRTwoAlgorithm.setTextRect()
    uiEntities.append(switchRTwoAlgorithm)

    pTwoDifficulty = Label((1920//4)*3, 905, 0, 1, 1, "Einfach", (0, 110, 18), 40)
    pTwoDifficulty.setTextRect()
    uiEntities.append(pTwoDifficulty)

    switchLTwoDifficulty = Button((1920//16)*11 - 40, 890, 0, 50, 40, "<<", (0,110,18), 40)
    switchLTwoDifficulty.setTextRect()
    uiEntities.append(switchLTwoDifficulty)
    
    switchRTwoDifficulty = Button((1920//16)*13, 890, 0, 50, 40, ">>", (0,110,18), 40)
